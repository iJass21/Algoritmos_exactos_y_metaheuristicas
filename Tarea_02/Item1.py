...
if __name__ == "__main__":
    ...
    print(f'Greedy Determinista:\nLugares obtenidos: {lugares_obtenidos_determinista}')
    print(f'Valor de la función objetivo: {valor_funcion_objetivo_determinista}')
    print(f'Tiempo de ejecución: {tiempo_ejecucion_determinista:.8f} segundos')
    ...
    print(f'\nGreedy Estocástico:\nLugares obtenidos: {lugares_obtenidos_estocastico}')
    print(f'Valor de la función objetivo: {valor_funcion_objetivo_estocastico}')
    print(f'Tiempo de ejecución: {tiempo_ejecucion_estocastico:.8f} segundos')
